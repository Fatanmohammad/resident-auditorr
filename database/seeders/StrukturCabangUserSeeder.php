...
class StrukturCabangUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cabangs = [
            ...
            ['BS-005',  'Cabang Sigi',                  'cabang_b',    'BS-000'],
            ...
            ['BS-010',  'Cabang Palu Barat',            'cabang_b',    'BS-000'],
            ['BS-011',  'Cabang Tolitoli',              'cabang_b',    'BS-000'],
            ['BS-012',  'Cabang Bungku',                'cabang_b',    'BS-000'],
            ['BS-013',  'Cabang Ampana',                'cabang_b',    'BS-000'],
            ['BS-014',  'Cabang Kolonodale',            'cabang_b',    'BS-000'],
